                ...
                <div>
                    ...
                    <ul className="space-y-4 text-gray-300 text-sm font-semibold">
                        ...
                        <li className="flex items-center gap-3">
                            ...
                            <a href="tel:+420775059591" className="hover:text-accent transition">+420 775 059 591</a>
                        </li>
                        <li className="flex items-center gap-3">
                    ...
                    <ul className="space-y-2 text-gray-300 text-sm font-semibold">
                        {groupedHours.map((group, index) => (
                            <li
                              ...
                              ${group.isClosed ? 'opacity-50 text-xs' : ''}`}
                            >
                                <span className={group.isClosed ? 'opacity-50' : ''}>{group.label}</span>
                                <span className={`uppercase tracking-tighter ${group.isToday && !group.isClosed ? 'text-accent' : ''}`}>{group.time}</span>
                            </li>
                        ))}
                    </ul>
                </div>
